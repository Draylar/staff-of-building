...
public class ModItems {
    ...
    public static final Item NETHERITE_BUILDER_STAFF = register("netherite_builder_staff", new BuilderStaffItem(new Item.Settings().group(StaffOfBuilding.GROUP).maxDamage(1250), 61, Items.NETHERITE_INGOT)); // +20
